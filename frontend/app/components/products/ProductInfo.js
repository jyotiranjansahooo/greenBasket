  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3 text-gray-600">
        ...
        <div className="flex items-center gap-2">
          <FiCalendar />
          Harvest: {product.harvestDate?.slice(0, 10)}
        </div>
      </div>

      <div className="rounded-2xl bg-white p-5 shadow">
        <h3 className="text-gray-700 font-semibold">Farmer Information</h3>

        <p className="mt-2 text-gray-700">👨‍🌾 {product.farmer?.name}</p>

        <p className="text-gray-700">📞 {product.farmer?.phone}</p>
      </div>
